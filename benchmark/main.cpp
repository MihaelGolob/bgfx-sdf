...
const int k_window_width_ = 1000;
const int k_window_height_ = 1000;
...
void BenchmarkGlyphError() {
    auto glyph_error_benchmark = GlyphErrorBenchmark(font_manager_, window_, font_file_);
    glyph_error_benchmark.RunBenchmark();
}
